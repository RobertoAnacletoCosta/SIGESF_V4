...
namespace SIGESF.Models
{
    public class AgenteSuprido
    {
        ...
        [StringLength(11, ErrorMessage = "Máxio de 11 caracteres")]
        [Display(Name = "Número da matricula")]
        public string Matricula { get; set; }

        [Required(ErrorMessage = "Obrigatório informar o CPF")]
        [StringLength(100, ErrorMessage = "Máxio de 100 caracteres")]
        [Display(Name = "CPF")]
        ...
        public virtual ICollection<ConcessaoSuprimentoFundos> Concessoes { get; set; }
    }
}